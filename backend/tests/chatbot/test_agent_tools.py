"""
Unit tests for the Plane tool functions in chatbot.agent.tools.
...
from plane_client.exceptions import PlaneAPIError, PlaneAuthError


class ListProjectsToolTest(TestCase):
    @patch("chatbot.agent.tools.PlaneClient")
    def test_list_projects_success(self, MockClient):
        ...
        from chatbot.agent.tools import list_projects
...
class ListIssuesToolTest(TestCase):
    ...
    def test_list_issues_success(self, MockClient):
        ...
        from chatbot.agent.tools import list_issues
...
class CreateIssueToolTest(TestCase):
    ...
    def test_create_issue_success(self, MockClient):
        ...
        from chatbot.agent.tools import create_issue
...
class AddCommentToolTest(TestCase):
    ...
    def test_add_comment_success(self, MockClient):
        ...
        from chatbot.agent.tools import add_comment
